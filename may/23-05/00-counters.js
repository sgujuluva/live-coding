...
/*
    2. Create other two functions that do the exact same thing (counting the number 
    of times they have been called), but the counter of one function should be 
    independend from the one in the other
...
console.log("myCounter2",myCounter2()); // 3
console.log(myCounter3()); // 2
console.log("myCounter2",myCounter2()); // 4

/**
 * We have a function to flip a coin a we can guess the outcome.
 *
 * Complete the code so that it can keep track of our score. For example, if we 
 * call it 5 times and we make 3 correct guesses, the score should be 3.
 *
 */
